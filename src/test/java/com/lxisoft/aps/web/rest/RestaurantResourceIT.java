...
class RestaurantResourceIT {
    ...
    public static Restaurant createEntity() {
        return new Restaurant().name(DEFAULT_NAME).cuisine(DEFAULT_CUISINE).rating(DEFAULT_RATING).locationString(DEFAULT_LOCATION_STRING);
    }
    ...
    public static Restaurant createUpdatedEntity() {
        return new Restaurant().name(UPDATED_NAME).cuisine(UPDATED_CUISINE).rating(UPDATED_RATING).locationString(UPDATED_LOCATION_STRING);
    }
    ...
    void getAllRestaurants() {
        ...
        webTestClient
            ...
            .jsonPath("$.[*].locationString")
            .value(hasItem(DEFAULT_LOCATION_STRING));
    }
    ...
    void getRestaurant() {
        ...
        webTestClient
            ...
            .jsonPath("$.locationString")
            .value(is(DEFAULT_LOCATION_STRING));
    }
    ...
    void putExistingRestaurant() throws Exception {
        ...
        updatedRestaurant.name(UPDATED_NAME).cuisine(UPDATED_CUISINE).rating(UPDATED_RATING).locationString(UPDATED_LOCATION_STRING);
    ...
    void partialUpdateRestaurantWithPatch() throws Exception {
        ...
        partialUpdatedRestaurant.cuisine(UPDATED_CUISINE);
    ...
    void fullUpdateRestaurantWithPatch() throws Exception {
        ...
        partialUpdatedRestaurant.name(UPDATED_NAME).cuisine(UPDATED_CUISINE).rating(UPDATED_RATING).locationString(UPDATED_LOCATION_STRING);
