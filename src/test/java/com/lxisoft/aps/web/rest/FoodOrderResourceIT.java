...
class FoodOrderResourceIT {
    ...
    private static final String DEFAULT_DELIVERY_LOCATION_STRING = "AAAAAAAAAA";
    private static final String UPDATED_DELIVERY_LOCATION_STRING = "BBBBBBBBBB";
    ...
    public static FoodOrder createEntity() {
        return new FoodOrder()
            ...
            .deliveryLocationString(DEFAULT_DELIVERY_LOCATION_STRING)
    ...
    public static FoodOrder createUpdatedEntity() {
        return new FoodOrder()
            ...
            .deliveryLocationString(UPDATED_DELIVERY_LOCATION_STRING)
    ...
    void getAllFoodOrders() {
        ...
        webTestClient
            ...
            .jsonPath("$.[*].deliveryLocationString")
            .value(hasItem(DEFAULT_DELIVERY_LOCATION_STRING))
            .jsonPath("$.[*].status")
    ...
    void getFoodOrder() {
        ...
        webTestClient
            ...
            .jsonPath("$.deliveryLocationString")
            .value(is(DEFAULT_DELIVERY_LOCATION_STRING))
            .jsonPath("$.status")
