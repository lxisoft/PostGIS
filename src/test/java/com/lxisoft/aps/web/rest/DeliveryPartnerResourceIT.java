...
class DeliveryPartnerResourceIT {
    ...
    public static DeliveryPartner createEntity() {
        return new DeliveryPartner().name(DEFAULT_NAME).status(DEFAULT_STATUS).locationString(DEFAULT_LOCATION_STRING);
    }
    ...
    public static DeliveryPartner createUpdatedEntity() {
        return new DeliveryPartner().name(UPDATED_NAME).status(UPDATED_STATUS).locationString(UPDATED_LOCATION_STRING);
    }
    ...
    void putExistingDeliveryPartner() throws Exception {
        ...
        updatedDeliveryPartner.name(UPDATED_NAME).status(UPDATED_STATUS).locationString(UPDATED_LOCATION_STRING);
    ...
    void partialUpdateDeliveryPartnerWithPatch() throws Exception {
        ...
        partialUpdatedDeliveryPartner.status(UPDATED_STATUS);
    ...
    void fullUpdateDeliveryPartnerWithPatch() throws Exception {
        ...
        partialUpdatedDeliveryPartner.name(UPDATED_NAME).status(UPDATED_STATUS).locationString(UPDATED_LOCATION_STRING);
