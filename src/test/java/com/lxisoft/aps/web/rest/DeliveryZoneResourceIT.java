...
class DeliveryZoneResourceIT {
    ...
    private static final String DEFAULT_BOUNDARY = "AAAAAAAAAA";
    private static final String UPDATED_BOUNDARY = "BBBBBBBBBB";
    ...
    public static DeliveryZone createEntity() {
        return new DeliveryZone().name(DEFAULT_NAME).active(DEFAULT_ACTIVE).boundary(DEFAULT_BOUNDARY);
    }
    ...
    public static DeliveryZone createUpdatedEntity() {
        return new DeliveryZone().name(UPDATED_NAME).active(UPDATED_ACTIVE).boundary(UPDATED_BOUNDARY);
    }
    ...
    void getAllDeliveryZones() {
        ...
        webTestClient
            ...
            .jsonPath("$.[*].boundary")
            .value(hasItem(DEFAULT_BOUNDARY));
    }
    ...
    void putExistingDeliveryZone() throws Exception {
        ...
        updatedDeliveryZone.name(UPDATED_NAME).active(UPDATED_ACTIVE).boundary(UPDATED_BOUNDARY);
    ...
    void partialUpdateDeliveryZoneWithPatch() throws Exception {
        ...
        partialUpdatedDeliveryZone.boundary(UPDATED_BOUNDARY);
    ...
    void fullUpdateDeliveryZoneWithPatch() throws Exception {
        ...
        partialUpdatedDeliveryZone.name(UPDATED_NAME).active(UPDATED_ACTIVE).boundary(UPDATED_BOUNDARY);
