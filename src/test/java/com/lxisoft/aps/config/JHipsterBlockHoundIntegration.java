...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.lxisoft.aps.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.lxisoft.aps.security.DomainUserDetailsService", "createSpringSecurityUser");
