...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DELIVERYREQUEST_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DELIVERYREQUEST actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DELIVERYREQUEST actions', async () => {
      const arg = { id: 12538 };
    ...
    it('dispatches UPDATE_DELIVERYREQUEST actions', async () => {
      const arg = { id: 12538 };
    ...
    it('dispatches PARTIAL_UPDATE_DELIVERYREQUEST actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DELIVERYREQUEST actions', async () => {
      const arg = 42666;
