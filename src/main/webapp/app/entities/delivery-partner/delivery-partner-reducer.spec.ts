...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DELIVERYPARTNER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DELIVERYPARTNER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DELIVERYPARTNER actions', async () => {
      const arg = { id: 20533 };
    ...
    it('dispatches UPDATE_DELIVERYPARTNER actions', async () => {
      const arg = { id: 20533 };
    ...
    it('dispatches PARTIAL_UPDATE_DELIVERYPARTNER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DELIVERYPARTNER actions', async () => {
      const arg = 42666;
