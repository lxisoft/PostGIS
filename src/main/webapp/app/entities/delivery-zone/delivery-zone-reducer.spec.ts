...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DELIVERYZONE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DELIVERYZONE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DELIVERYZONE actions', async () => {
      const arg = { id: 8142 };
    ...
    it('dispatches UPDATE_DELIVERYZONE actions', async () => {
      const arg = { id: 8142 };
    ...
    it('dispatches PARTIAL_UPDATE_DELIVERYZONE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DELIVERYZONE actions', async () => {
      const arg = 42666;
