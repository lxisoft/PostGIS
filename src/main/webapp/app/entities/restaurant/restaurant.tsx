...
export const Restaurant = () => {
  ...
  const totalItems = useAppSelector(state => state.restaurant.totalItems);
  ...
  return (
    <div>
            ...
            <tbody>
              {restaurantList.map((restaurant, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{restaurant.locationString}</td>
                  <td className="text-end">
                    <div className="btn-group flex-btn-group-container">
                      ...
                      <Button
                        tag={Link}
                        to={`/restaurant/${restaurant.id}/edit?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`}
                        color="primary"
                        size="sm"
                      ...
                      <Button
                        onClick={() =>
                          (window.location.href = `/restaurant/${restaurant.id}/delete?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`)
                        }
                        color="danger"
                        size="sm"
      ...
      {totalItems ? (
        <div className={restaurantList && restaurantList.length > 0 ? '' : 'd-none'}>
