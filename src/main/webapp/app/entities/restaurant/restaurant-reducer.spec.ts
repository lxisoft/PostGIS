...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RESTAURANT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_RESTAURANT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_RESTAURANT actions', async () => {
      const arg = { id: 18919 };
    ...
    it('dispatches UPDATE_RESTAURANT actions', async () => {
      const arg = { id: 18919 };
    ...
    it('dispatches PARTIAL_UPDATE_RESTAURANT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_RESTAURANT actions', async () => {
      const arg = 42666;
