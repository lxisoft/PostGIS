...
import { deleteEntity, getEntity } from './restaurant.reducer';
...
export const RestaurantDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate(`/restaurant${pageLocation.search}`);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="geoDeliveryApp.restaurant.delete.question">
        Are you sure you want to delete Restaurant {restaurantEntity.id}?
      </ModalBody>
      <ModalFooter>
