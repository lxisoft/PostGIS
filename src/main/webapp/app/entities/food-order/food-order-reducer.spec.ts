...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FOODORDER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_FOODORDER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_FOODORDER actions', async () => {
      const arg = { id: 31953 };
    ...
    it('dispatches UPDATE_FOODORDER actions', async () => {
      const arg = { id: 31953 };
    ...
    it('dispatches PARTIAL_UPDATE_FOODORDER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_FOODORDER actions', async () => {
      const arg = 42666;
